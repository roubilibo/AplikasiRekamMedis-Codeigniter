			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Nama Dokter</label>
				      <input type="text" name="e_nama_dokter" id="e_nama_dokter" class="form-control" required ="">
				    </div>
				  </div>
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Spesialis</label>
				      <input type="text" name="e_spesialis" id="e_spesialis" class="form-control" required ="">
				    </div>
				  </div>
				</div>
				...
				<div class="row">
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Alamat</label>
				      <input type="text" name="e_alamat" id="e_alamat" class="form-control" required ="">
				    </div>
				  </div>
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
...
$(document).ready(function(e){
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_dokter').val($(this).data('nama_dokter'));
		$('#e_spesialis').val($(this).data('spesialis'));
