				...
				<div class="row">
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>ICD</label>
				      <input type="text" name="icd" id="icd" class="form-control" required ="">
				    </div>
				  </div>
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Nama diagnosa</label>
				      <input type="text" name="nama_diagnosa" id="nama_diagnosa" class="form-control" required ="">
				    </div>
				  </div>
				</div>
			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>ICD</label>
				      <input type="text" name="e_icd" id="e_icd" class="form-control" required ="">
				    </div>
				  </div>
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Nama diagnosa</label>
				      <input type="text" name="e_nama_diagnosa" id="e_nama_diagnosa" class="form-control" required ="">
				    </div>
				  </div>
				</div>
...
$(document).ready(function(e){
	...
	var nm_tabel = "pengaturan_diagnosa";
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_diagnosa').val($(this).data('diagnosa'));
		$('#e_icd').val($(this).data('icd'));
