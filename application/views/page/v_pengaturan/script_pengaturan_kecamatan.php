			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      <label>Nama kecamatan</label>
				      <input type="text" name="e_nama_kecamatan" id="e_nama_kecamatan" class="form-control" required ="">
				    </div>
				  </div>
				</div>
...
$(document).ready(function(e){
	...
	var nm_tabel = "pengaturan_kecamatan";
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_kecamatan').val($(this).data('nama_kecamatan'));
