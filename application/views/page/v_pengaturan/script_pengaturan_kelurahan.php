			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      <label>Nama kelurahan</label>
				      <input type="text" name="e_nama_kelurahan" id="e_nama_kelurahan" class="form-control" required ="">
				    </div>
				  </div>
				</div>
...
$(document).ready(function(e){
	...
	var nm_tabel = "pengaturan_kelurahan";
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_kelurahan').val($(this).data('nama_kelurahan'));
