			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      <label>Nama pekerjaan</label>
				      <input type="text" name="e_nama_pekerjaan" id="e_nama_pekerjaan" class="form-control" required ="">
				    </div>
				  </div>
				</div>
...
$(document).ready(function(e){
	...
	var nm_tabel = "pengaturan_pekerjaan";
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_pekerjaan').val($(this).data('nama_pekerjaan'));
