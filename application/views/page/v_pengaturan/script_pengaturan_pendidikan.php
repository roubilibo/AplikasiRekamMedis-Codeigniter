				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      ...
				      <input type="text" name="nama_pendidikan" id="nama_pendidikan" class="form-control" required ="">
				    </div>
				  </div>
				</div>
			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      <label>Nama pendidikan</label>
				      <input type="text" name="e_nama_pendidikan" id="e_nama_pendidikan" class="form-control" required ="">
				    </div>
				  </div>
				</div>
...
$(document).ready(function(e){
	...
	var nm_tabel = "pengaturan_pendidikan";
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_pendidikan').val($(this).data('nama_pendidikan'));
