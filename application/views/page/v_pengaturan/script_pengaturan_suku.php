				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      ...
				      <input type="text" name="nama_suku" id="nama_suku" class="form-control" required ="">
				    </div>
				  </div>
				</div>
			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-12">
				    <div class="form-group form-group-default">
				      <label>Nama suku</label>
				      <input type="text" name="e_nama_suku" id="e_nama_suku" class="form-control" required ="">
				    </div>
				  </div>
				</div>
...
$(document).ready(function(e){
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_suku').val($(this).data('nama_suku'));
