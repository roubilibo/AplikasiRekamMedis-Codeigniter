			...
			<form method="POST" action="#" id="formEdit" enctype="multipart/form-data">
				...
				<div class="row">
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Nama User</label>
				      <input type="text" name="e_nama_user" id="e_nama_user" class="form-control" required ="">
				    </div>
				  </div>
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Username</label>
				      <input type="text" name="e_username" id="e_username" class="form-control" required ="">
				    </div>
				  </div>
				</div>
				...
				<div class="row">
				  <div class="col-md-6">
				    <div class="form-group form-group-default">
				      <label>Level</label>
				      <select name="e_level" id="e_level" class="form-control select2" required="">
				      	<option></option>
				      	<option>admin</option>
				      	<option>user</option>
				      	<option>dokter</option>
...
$(document).ready(function(e){
	...
	$('#datatable').on('click','.editData',function(){
		...
		$('#e_nama_user').val($(this).data('nama_user'));
		$('#e_username').val($(this).data('username'));
		$('#e_level').val($(this).data('level')).trigger('change');
